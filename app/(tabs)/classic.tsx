...
export default function ClassicTab() {
  ...
  const diagonalAllowed = boxSize === 3;

  const handleStart = () => {
    startGame(boxSize, difficulty, { mode: 'classic', diagonal: diagonalAllowed && diagonal });
    router.push('/game');
  };
      ...
      >
        ...
        {diagonalAllowed && (
          <View style={[styles.section, isWide && styles.sectionWide]}>
            ...
            >
              <View style={styles.diagonalLabelGroup}>
                <Ionicons name="swap-horizontal" size={22} color={colors.primary} />
                <View style={{ flex: 1 }}>
                  <Text style={[styles.diagonalLabel, { color: colors.text }]}>
                    {t.home.diagonalRule}
                  </Text>
                  <Text style={[styles.diagonalDesc, { color: colors.textMuted }]}>
                    {t.home.diagonalRuleDesc}
                  </Text>
                </View>
              </View>
              <Switch
                value={diagonal}
                onValueChange={setDiagonal}
...
const styles = StyleSheet.create({
  ...
  modeBtn: { flex: 1, paddingVertical: 16, paddingHorizontal: 12, borderRadius: 14, borderWidth: 2, alignItems: 'center', ...SHADOWS.small },
  modeBtnLabel: { fontSize: 20, fontWeight: '700' },
  modeBtnDesc: { fontSize: 11, marginTop: 2 },
  difficultyList: { gap: 8 },
  diffBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 14, paddingHorizontal: 16, borderRadius: 12, borderWidth: 1.5, borderLeftWidth: 4, ...SHADOWS.small },
  ...
  diagonalLabelGroup: { flexDirection: 'row', alignItems: 'center', gap: 12, flex: 1 },
  diagonalLabel: { fontSize: 15, fontWeight: '700' },
  diagonalDesc: { fontSize: 12, marginTop: 2 },
  startBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, paddingVertical: 18, borderRadius: 16, marginTop: 8, ...SHADOWS.medium },
  startBtnWide: { maxWidth: 400, alignSelf: 'center', width: '100%' },
  startBtnText: { fontSize: 20, fontWeight: '700' },
  journeyBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, paddingVertical: 16, borderRadius: 16, backgroundColor: '#7C3AED', marginTop: 12, ...SHADOWS.medium },
  journeyBtnText: { fontSize: 18, fontWeight: '700' },
  dashboardBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, paddingVertical: 16, borderRadius: 16, marginTop: 12, borderWidth: 2, ...SHADOWS.small },
  dashboardBtnText: { fontSize: 18, fontWeight: '700' },
  themeBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, paddingVertical: 16, borderRadius: 16, marginTop: 12, borderWidth: 1.5 },
  themeBtnText: { fontSize: 18, fontWeight: '700' },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', alignItems: 'center', justifyContent: 'center' },
  modalCard: { borderRadius: 20, padding: 28, alignItems: 'center', marginHorizontal: 32, maxWidth: 360, width: '90%', ...SHADOWS.large },
  modalTitle: { fontSize: 20, fontWeight: '700', marginBottom: 20 },
  themeList: { width: '100%', gap: 10 },
  themeOption: { flexDirection: 'row', alignItems: 'center', gap: 14, paddingVertical: 14, paddingHorizontal: 16, borderRadius: 12, borderWidth: 2 },
  themePreview: { width: 32, height: 32, borderRadius: 10 },
  themeLabel: { fontSize: 16, fontWeight: '600', flex: 1 },
  modalCloseBtn: { marginTop: 20, paddingVertical: 12, paddingHorizontal: 40, borderRadius: 12 },
  modalCloseBtnText: { fontSize: 16, fontWeight: '700' },
